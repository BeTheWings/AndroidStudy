package com.example.tablerowcal;
            ...
            numButtons[index].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (editText1.isFocused() == true) {
                        num1 = editText2.getText().toString() + numButtons[index].getText().toString();
                        ...
                        Toast.makeText(getApplicationContext(), "먼저 테스트를 선택하세요", Toast.LENGTH_SHORT).show();
                    }
                }
            });
